...
import {BottomModal, BoxNota, Card, RadarChart, Space, Text} from 'components';
...
const ProfileResearchVisualization = ({onBack, researh}: Props) => {
...
export default ProfileResearchVisualization;
